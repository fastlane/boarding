...
**Important:** With the most recent update of TestFlight, both [pilot](https://fastlane.tools/pilot) and `boarding` need to be updated to make use of the new API. Please follow [#8871](https://github.com/fastlane/fastlane/pull/8871) to stay up to date. We're trying to get a fix out as soon as possible.
